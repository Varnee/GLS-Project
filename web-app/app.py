...
def my_playlist():
    ...
    sp, top_genres, top_genres_and_artists = get_top_genres(auth_manager, term="medium_term")
    top_genre = genre_selection(top_genres, 0)
    _, all_tracks, user_name = return_all_tracks(sp, top_genre, top_genres_and_artists, term="medium_term")
...
def save_playlist():
    ...
    tracks_df = pd.DataFrame(list(tracks))
    # export dataframe to csv file
    tracks_df.to_csv("track_df.csv", index=False)
